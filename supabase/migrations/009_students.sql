...
--                 + their updated_at triggers + RLS enable ONLY.
--
...
--           Does NOT touch Migration 001-008 objects (schools,
--           school_accounts, admin_profiles, school_classes,
--           academic_years, reference tables), Auth users, or existing
--           school/admin login flows.
